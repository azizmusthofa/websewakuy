				...
				<div class="col-md-4 col-sm-6">
					<div class="shop">
						...
						<div class="shop-body">
							...
							@if($n==0)
							<a href="/home/Kendaraan" class="cta-btn">Sewa <i class="fa fa-arrow-circle-right"></i></a>
							@elseif($n==1)
							<a href="/home/Elektronik" class="cta-btn">Sewa <i class="fa fa-arrow-circle-right"></i></a>
							@else
							<a href="/home/Alat Pesta" class="cta-btn">Sewa <i class="fa fa-arrow-circle-right"></i></a>
							@endif
						</div>
					</div>
				</div>
